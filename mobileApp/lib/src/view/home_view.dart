...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
        body: needUpdateAppPopup(
          ...
          child: ListView(
            children: [
              _image(context, 'assets/home_page/example.jpeg', nbItems: 2),
              // _image(context, 'assets/home_page/example.png'),
              _gridItem(
                context,
                "Calendrier",
...
_image(BuildContext context, String path, {int nbItems = 1}) => Image.asset(
      path,
